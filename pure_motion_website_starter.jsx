...
export default function App() {
  ...
  return (
    <div style={wrapper}>
      ...
      {page === "tracksuits" && <Section title="Tracksuits"><ProductGrid items={products.tracksuits} setSelected={setSelected}/></Section>}

      {page === "jerseys" && <Section title="Jerseys"><ProductGrid items={products.jerseys} setSelected={setSelected}/></Section>}

      {page === "dance" && <Section title="Dance & Fitness"><ProductGrid items={products.dance} setSelected={setSelected}/></Section>}

      {page === "hoodies" && <Section title="Hoodies"><ProductGrid items={products.hoodies} setSelected={setSelected}/></Section>}
